...
# Student name: Mr. Bodin Saensuk นายบดินทร์ แสนสุข
# Student ID: 653380135-9
...
if __name__ == '__main__':
    ...
    # print(print_promotion(1400))
    # print(print_promotion(2400))
    # print(print_promotion(3500))
    
    # #Negative Test Case
    #print(print_promotion('one hundred'))
    #print(print_promotion(-1000))
    print(print_promotion(None))